...
export default function Auth({ setToken }) {
    ...
    const navigate = useNavigate(); // Para redirigir a Home

    const handleAuth = async (e) => {
        e.preventDefault();
        const url = isLogin ? `${import.meta.env.VITE_API_URL}/login` : `${import.meta.env.VITE_API_URL}/register`;
        const data = isLogin ? { email, password } : { nombre, apellidos, email, password };
